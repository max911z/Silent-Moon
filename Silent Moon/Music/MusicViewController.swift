...
class MusicViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setup()
        view.backgroundColor = UIColor(named: "backgroundSleepPlayer")
    ...
    private func setupBackButton(){
        ...
        let backButtonBackground = UIImage(named: "musicBackButton")
    ...
    private func setupLikeButton(){
        ...
        let likeButtonBackground = UIImage(named: "likeMusic")
    ...
    private func setupDownloadButton(){
        ...
        let downloadButtonBackground = UIImage(named: "downloadMusic")
    ...
    private func setupMainLabel(){
        ...
        mainLabel.textColor = UIColor(named: "textColorSleepMusic")
    ...
    private func setupSecondaryLabel(){
        ...
        secondaryLabel.textColor = UIColor(named: "secondTextColorSleepMusic")
    ...
    private func setupPlayButton(){
        ...
        let playButtonBackground = UIImage(named: "playSleepMusic")
    ...
    private func setupSlider(){
        ...
        slider.thumbTintColor = UIColor(named: "tabBarColor")
    ...
    private func setupLeftButton(){
        ...
        let backButtonBackground = UIImage(named: "backSleep")
    ...
    private func setupRightButton(){
        ...
        let forwardButtonBackground = UIImage(named: "forwardSleep")
    ...
    private func setupLeftTimeLabel(){
        ...
        leftTimeLabel.textColor = UIColor(named: "textColorSleepMusic")
    ...
    private func setupRightTimeLabel(){
        ...
        rightTimeLabel.textColor = UIColor(named: "textColorSleepMusic")
